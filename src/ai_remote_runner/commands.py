...
COMMANDS: dict[tuple[str, ...], CommandSpec] = {
    ...
    ("预算", "设置"): CommandSpec("budget.set_task_reserved", "设置 Telegram/AI 单次任务预留预算；0/无限 表示不传 Claude Code 原生预算上限。"),
    ("预算", "单次"): CommandSpec("budget.set_task_reserved", "设置 Telegram/AI 单次任务预留预算；0/无限 表示不传 Claude Code 原生预算上限。"),
    ("budget", "set"): CommandSpec("budget.set_task_reserved", "设置 Telegram/AI 单次任务预留预算；支持 unlimited/无限。"),
    ("轮数", "设置"): CommandSpec("claude.max_turns.set", "设置 Claude Code 最大工具轮数；0/无限 表示不传原生 --max-turns。"),
    ("最大轮数", "设置"): CommandSpec("claude.max_turns.set", "设置 Claude Code 最大工具轮数；0/无限 表示不传原生 --max-turns。"),
    ("turns", "set"): CommandSpec("claude.max_turns.set", "设置 Claude Code 最大工具轮数；支持 unlimited/无限。"),
    ("max-turns", "set"): CommandSpec("claude.max_turns.set", "设置 Claude Code 最大工具轮数；支持 unlimited/无限。"),
    ("重试", "设置"): CommandSpec("claude.retry.set", "设置 Claude Code 网关/API 临时错误自动重试次数，范围 0-5。"),
    ("retry", "set"): CommandSpec("claude.retry.set", "设置 Claude Code 网关/API 临时错误自动重试次数。"),
    ("api-retry", "set"): CommandSpec("claude.retry.set", "设置 Claude Code 网关/API 临时错误自动重试次数。"),
