...
PY
            ...
            self.assertNotIn("StartLimitIntervalSec", telegram_unit.read_text(encoding="utf-8"))
...
PY
            ...
            self.assertEqual(settings["env"]["ANTHROPIC_API_URL"], "https://example.invalid")
            self.assertEqual(settings["env"]["ANTHROPIC_AUTH_TOKEN"], "fixture-token")
            self.assertEqual(settings["env"]["ANTHROPIC_API_KEY"], "fixture-token")
            self.assertEqual(settings["env"]["CLAUDE_CODE_DISABLE_OAUTH"], "1")
...
PY
            ...
            self.assertIn("CLAUDE_CODE_DISABLE_OAUTH=1", config)
            self.assertIn("ANTHROPIC_API_URL=https://example.invalid", config)
