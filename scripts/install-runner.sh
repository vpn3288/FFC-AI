...
if [ "$DRY_RUN" = false ]; then
  ...
  EFFECTIVE_CLAUDE_API_RETRY_ATTEMPTS="${CLAUDE_API_RETRY_ATTEMPTS:-${PREVIOUS_CLAUDE_API_RETRY_ATTEMPTS:-5}}"
  ...
  EFFECTIVE_VSCODE_CLAUDE_API_RETRY_ATTEMPTS="${VSCODE_CLAUDE_API_RETRY_ATTEMPTS:-${PREVIOUS_VSCODE_CLAUDE_API_RETRY_ATTEMPTS:-5}}"
