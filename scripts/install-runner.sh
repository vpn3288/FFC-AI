...
if [ "$DRY_RUN" = false ]; then
  ...
  EFFECTIVE_AI_TASK_TIMEOUT_SECONDS="${AI_TASK_TIMEOUT_SECONDS:-${PREVIOUS_AI_TASK_TIMEOUT_SECONDS:-3600}}"
  EFFECTIVE_CLAUDE_MAX_TURNS="${CLAUDE_MAX_TURNS:-${PREVIOUS_CLAUDE_MAX_TURNS:-50}}"
  EFFECTIVE_CLAUDE_API_RETRY_ATTEMPTS="${CLAUDE_API_RETRY_ATTEMPTS:-${PREVIOUS_CLAUDE_API_RETRY_ATTEMPTS:-8}}"
  EFFECTIVE_CLAUDE_API_RETRY_SLEEP_SECONDS="${CLAUDE_API_RETRY_SLEEP_SECONDS:-${PREVIOUS_CLAUDE_API_RETRY_SLEEP_SECONDS:-5}}"
  EFFECTIVE_VSCODE_CLAUDE_MAX_TURNS="${VSCODE_CLAUDE_MAX_TURNS:-${PREVIOUS_VSCODE_CLAUDE_MAX_TURNS:-50}}"
  EFFECTIVE_VSCODE_CLAUDE_API_RETRY_ATTEMPTS="${VSCODE_CLAUDE_API_RETRY_ATTEMPTS:-${PREVIOUS_VSCODE_CLAUDE_API_RETRY_ATTEMPTS:-8}}"
